...
LABEL MAINTAINER="Dongchao(Alan) Chen"
...
# extra dependencies (over what r-base:latest already includes)
...
RUN Rscript -e "source('/home/rstudio/install_packages.R')" \
 	&& rm -rf /tmp/downloaded_packages/ /tmp/*.rds \
    && rm -rf /tmp/* \
    && rm -rf /home/rstudio/install_packages.R
